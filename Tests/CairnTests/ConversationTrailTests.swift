...
func editorStatusDoesNotGuessForAnUnknownOrIncompleteExtensionHost() {
    let status = "  0  0  55476  extension-host [4]\n"
    #expect(TrailFinder.editorWindowTitle(in: status, forExtensionHostPID: 55476) == nil)
    #expect(TrailFinder.editorWindowTitle(in: status, forExtensionHostPID: 99999) == nil)
}
